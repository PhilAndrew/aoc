...
const CoordinatorCaseList = [
  {image: Immigration, lawyerName: 'Violet Wong', title: 'Children’s Protection Network', details: 'Assist a local NGO deliver training to youth detained at immigration detention centers to understand their legal rights and obtain information relevant to reunification with their families or guardians.', practiceArea: ['immigration'], legalSkill: ['advocacy', 'training'], jurisdictions: ['United States of America'], languages: ['English'], priority: 'immediate' },
  {image: cpbs, lawyerName: 'Davyd Tang', title: 'Domestic Caregiver', details: 'Assist a company that ethically sources foreign domestic workers by providing pro bono legal assistance on setting up a charitable legal entity in order to extend their services to low-income families in Hong Kong', practiceArea: ['corporate', 'employment'], legalSkill: ['advice', 'research'], jurisdictions: ['Hong Kong'], languages: ['English'], priority: 'flexible' }, 
]
