  ...
  <GuestLayout>
    ...
    <div className="row ">
        ...
        <form className="needs-validation" noValidate>
            ...
            <select className="custom-select d-block w-100" id="deadline" required>
                <option defaultValue="">Choose...</option>
                <option>?</option>
            </select>
            </div>
            ...
            <div className="mb-3">
            <label htmlFor="priority">Language</label>
            <select className="custom-select d-block w-100" id="language" required>
                <option defaultValue="">Choose...</option>
                <option>?</option>
            </select>
            </div>
