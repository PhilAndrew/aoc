...
export default () => (
  <GuestLayout>
    ...
    <div className="page-middle container row ">
        ...
        <NgoCase image={Immegration} title="Document authentication - Sri Lanka" details="We require a Sri Lankan expert to authenticate an extract from the Information Book of of a Police Station in Negombo." />
        ...
        <NgoCase image={Immegration} title="Mender of Things" details="Help a young and passionate NGO increase youth awareness of the law and human rights through the arts by providing legal advice and assistance on setting up a legal entity in Hong Kong and applying for section 88 charitable status" />        
        <NgoCase image={Immegration} title="Serving Islam Team - Hong Kong" details="Assist a local NGO that helps educate the community on ethnic minorities and which also helps ethnic minorities integrate into the community by providing pro bono legal advice on the appropriate legal entity structure and possible application for section 88 charitable status" />        
        <NgoCase image={Immegration} title="StoryTaler" details="Assist a volunteer group focused on promoting mental health in Hong Kong by providing pro bono legal assistance on setting up a legal entity and applying for section 88 charitable status" />        
        <NgoCase image={Immegration} title="V Cycle" details="Support a social enterprise focused on environmental issues by providing pro bono legal advice on setting up a board and formalizing its shareholder arrangements" />        
        <NgoCase image={Immegration} title="OurConservatory" details="Assist an impact investing intermediary with a mission to bridge the gap between social &amp; commercial by establishing a long term legal partnership to support their Tech for Good incubator programme (NEW!)" />        
